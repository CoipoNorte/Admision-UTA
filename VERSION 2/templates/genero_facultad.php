        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Postulantes por Facultad</h1>
                ...
                <!--GRAFICO-->
                <h1 class="h2">Gráfico de Postulantes por Facultad (Hombres y Mujeres)</h1>
                ...
                // Consulta SQL
                $query = "SELECT c.NOMBRE_FACULTAD AS Nombre_Facultad,
